...
from src.dime.selectors import TopAlphaSelector
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="DIME masked retrieval sweep.",
...
def build_selector(selector_name: str):
    """Instantiate the requested DimSelector by name."""
    if selector_name == "top-alpha":
        return TopAlphaSelector()
    # ── add new selectors here ─────────────────────────────────────────────────
    # if selector_name == "your-method":
    #     from src.dime.selectors.your_method import YourMethodSelector
    #     return YourMethodSelector()
...
def main():
    ...
    # ── masked search sweep — skip if run exists ───────────────────────────────
